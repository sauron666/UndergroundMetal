...
import { Skull, Newspaper, Music, Theater, Megaphone, Activity, Flag, BarChart3, CalendarRange, ListChecks, UserPlus, Route, Layers } from "lucide-react";
...
const NAV = [
  ...
  { href: "/admin/tours", label: "Tour batch", icon: Route },
